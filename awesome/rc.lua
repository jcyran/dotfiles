...
beautiful.menu_bg_normal="#1f2430"
beautiful.menu_bg_focus="#707abc"
-- beautiful.menu_fg_normal="#707abc"
beautiful.menu_fg_focus="#1f2430"
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ " ", " ", "󱔗 ", " ", "󰎆 " }, s, awful.layout.layouts[1])
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, bg = beautiful.bg_normal .. "cc", opacity = 0.5, height = 23, border_width = 2, border_color = '#1f2430', }) -- shape = custom_shape })
...
{ description = "Brave", group = "jcyran" }),
